<template>
	...
	>
		...
		>
			...
			<el-form-item label="员工性别" prop="customerGender">
				<el-select v-model="formData.customerGender" prop="customerGender" clearable class="filter-item" style="width: 200px;" placeholder="请选择员工性别">
...
import { employeeSave, employeeUpdateById, getEmployeInfo } from '@/api/personnelManagement/employee'
