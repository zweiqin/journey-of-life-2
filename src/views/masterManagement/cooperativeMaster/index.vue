	...
	<div class="app-container">
		...
		>
			...
			<el-button
				...
				@click="(listQuery.isCooperationOrisBlacklist = 1) && (listQuery.search = '') || getList()"
			>
				重置
			</el-button>
		</div>
		...
		<TableTools
			...
			@update-fields="updateFields" @refresh="getList" @download="toolsMixin_exportMethod($refs.vxeTable, '已合作师傅')"
		>
		</TableTools>
